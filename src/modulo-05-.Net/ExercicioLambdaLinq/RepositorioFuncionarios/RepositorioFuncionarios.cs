...
namespace Repositorio
{
    public class RepositorioFuncionarios
    {
        ...
        {
            var filtFunc = Funcionarios.Where(funcionario => funcionario.Cargo.Equals(cargo));

            return filtFunc.ToList();
        }

        public IList<Funcionario> OrdenadosPorCargo()
        {
            var filtFunc = Funcionarios.OrderBy(funcionario => funcionario.Cargo.Titulo).ThenBy(f => f.Nome);
        ...
        {
            var func = Funcionarios.Where(f => f.Nome.Contains(nome));
        ...
        {
            var func = Funcionarios.Where(f => turnos.Contains(f.TurnoTrabalho));
        ...
        {
            var func = Funcionarios.Where(f => idade + 5 >= DateTime.Today.Year - f.DataNascimento.Year && idade - 5 <= DateTime.Today.Year - f.DataNascimento.Year);
        ...
        {
            var func = Funcionarios.Where(f => f.DataNascimento.Month.Equals(DateTime.Today.Month));
