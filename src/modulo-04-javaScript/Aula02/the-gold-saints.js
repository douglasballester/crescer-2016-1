...
//ANALISAR OS EXERCICIOS E EVITAR REPETIÇÃO DE CÓDIGO
//Exercicio 01
...
function obterAlturaMedia(){
  ...
  somaAltura = (somaAltura / 12)/100;
  return Math.round(somaAltura * 100) / 100;
}
...
function obterAlturaMediana (){
   ...
   mediana = ((arrayDasAlturas[5] + arrayDasAlturas[6])/2) / 100 ;
...
function obterPesoMedio(knights){
    ...
    calculaPesoMedio = (calculaPesoMedio / contCav) * 0.4546;
